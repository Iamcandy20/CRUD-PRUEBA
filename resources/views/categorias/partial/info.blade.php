      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" value="{{$categoria->nombre}}" placeholder="Ingresa nombre de categoria">
                </div>
                <div class="form-group">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" href="{{route("categorias.update", $categoria->id)}}">Guardar Cambios</button>
        </div>
      </div>
    </div>
  </div>
